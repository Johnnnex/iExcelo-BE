...
export class InitialMigration1777052609906 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE IF NOT EXISTS "migration_history" ("id" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "ranAt" TIMESTAMP NOT NULL, "durationMs" integer, CONSTRAINT "UQ_ace3683e3c6cee3dd06e27b1662" UNIQUE ("name"), CONSTRAINT "PK_63ad381728693434caed4dd922e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
