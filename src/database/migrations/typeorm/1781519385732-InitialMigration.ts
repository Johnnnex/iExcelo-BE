...
export class InitialMigration1781519385732 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "testimonials" ("id" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, "name" character varying NOT NULL, "role" character varying, "content" text NOT NULL, "rating" integer NOT NULL DEFAULT '5', "isPublished" boolean NOT NULL DEFAULT false, "displayOrder" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_63b03c608bd258f115a0a4a1060" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_7f0765126ba3234b3623850952" ON "testimonials" ("displayOrder") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_c0766e06094dc1c4a11908a9fd" ON "testimonials" ("isPublished") `,
    );
    await queryRunner.query(
      `CREATE TABLE "admin_roles" ("id" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "description" text, "modules" jsonb NOT NULL DEFAULT '{}', "createdById" uuid, CONSTRAINT "PK_091baca34754e848b9f8c4e7be9" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_6e9e938900168e4a0786bb6588" ON "admin_roles" ("name") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."admin_invites_status_enum" AS ENUM('pending', 'accepted', 'expired')`,
    );
    await queryRunner.query(
      `CREATE TABLE "admin_invites" ("id" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "email" character varying NOT NULL, "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "token" character varying NOT NULL, "status" "public"."admin_invites_status_enum" NOT NULL DEFAULT 'pending', "roleId" uuid, "modulePermissions" jsonb NOT NULL DEFAULT '{}', "createdById" uuid NOT NULL, "expiresAt" TIMESTAMP WITH TIME ZONE NOT NULL, "acceptedAt" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_79953c0faab15cd60084dc26486" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_9e5a1793624bccd4ae9856f7d2" ON "admin_invites" ("email") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "testimonials" ADD CONSTRAINT "FK_e4e5bb62ec2874c440b6cc3362f" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_roles" ADD CONSTRAINT "FK_aafcf2cc933fecb5eb5136dc629" FOREIGN KEY ("createdById") REFERENCES "admin_profiles"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "admin_profiles" ADD CONSTRAINT "FK_42f504529c195bd0369f31e7a40" FOREIGN KEY ("roleId") REFERENCES "admin_roles"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_profiles" ADD CONSTRAINT "FK_bf05b20a62ead201eff0a970e3b" FOREIGN KEY ("createdById") REFERENCES "admin_profiles"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "bulk_email_campaigns" ADD CONSTRAINT "FK_361817b7c77e54df623ddb47c11" FOREIGN KEY ("createdById") REFERENCES "admin_profiles"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_invites" ADD CONSTRAINT "FK_eceeab0ebae9ba00bc32eeb7139" FOREIGN KEY ("roleId") REFERENCES "admin_roles"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "admin_invites" DROP CONSTRAINT "FK_eceeab0ebae9ba00bc32eeb7139"`,
    );
    await queryRunner.query(
      `ALTER TABLE "bulk_email_campaigns" DROP CONSTRAINT "FK_361817b7c77e54df623ddb47c11"`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_profiles" DROP CONSTRAINT "FK_bf05b20a62ead201eff0a970e3b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_profiles" DROP CONSTRAINT "FK_42f504529c195bd0369f31e7a40"`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_profiles" DROP CONSTRAINT "FK_d1b5f61ecc9c83a766503b9eb77"`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_roles" DROP CONSTRAINT "FK_aafcf2cc933fecb5eb5136dc629"`,
    );
    await queryRunner.query(
      `ALTER TABLE "testimonials" DROP CONSTRAINT "FK_e4e5bb62ec2874c440b6cc3362f"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_9e5a1793624bccd4ae9856f7d2"`,
    );
    await queryRunner.query(`DROP TABLE "admin_invites"`);
    await queryRunner.query(`DROP TYPE "public"."admin_invites_status_enum"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_567f5d462e1a6545966c2b9c63"`,
    );
    await queryRunner.query(`DROP TABLE "bulk_email_campaigns"`);
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_6e9e938900168e4a0786bb6588"`,
    );
    await queryRunner.query(`DROP TABLE "admin_roles"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c0766e06094dc1c4a11908a9fd"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_7f0765126ba3234b3623850952"`,
    );
