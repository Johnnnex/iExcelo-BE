...
const JAMB_PRICES: Record<string, PriceRow> = {
  ...
  NAD: [95, 160, 260, 400],
  USD: [14.99, 19.99, 29.99, 44.99],
  GBP: [14.99, 19.99, 29.99, 44.99],
  CAD: [19.99, 29.99, 39.99, 59.99],
  AUD: [14.99, 19.99, 29.99, 44.99],
  EUR: [14.99, 19.99, 29.99, 44.99],
};
...
const WAEC_GCE_NECO_PRICES: Record<string, PriceRow> = {
  ...
  NAD: [85, 150, 250, 400],
  USD: [10, 14.99, 24.99, 39.99],
  GBP: [9.99, 14.99, 24.99, 39.99],
  CAD: [14.99, 24.99, 34.99, 54.99],
  AUD: [9.99, 14.99, 24.99, 39.99],
  EUR: [9.99, 14.99, 24.99, 39.99],
};
